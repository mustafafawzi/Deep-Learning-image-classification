...
# opslaan als .h5
BEST_MODEL_P1 = OUT_DIR / "best_model_phase1.h5"
BEST_MODEL_P2 = OUT_DIR / "best_model_phase2.h5"
...
# Class weights berekenen op basis van labels in train_ds
y_train = np.concatenate([y.numpy() for _, y in train_ds]).astype(int).ravel()
...
history_p1 = model.fit(
    ...
    class_weight=class_weight  # class weights gebruiken
)
...
# VGG16 base model terugvinden in het geladen model
...
history_p2 = model.fit(
    ...
    class_weight=class_weight  # ook in finetune phase
)
