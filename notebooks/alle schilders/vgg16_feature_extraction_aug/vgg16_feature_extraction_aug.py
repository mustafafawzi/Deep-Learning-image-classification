# vgg16_feature_extraction_aug.py
# ------------------------------------------------------------
# VGG16 Feature Extraction (conv base frozen) + Data Augmentation — multiclass
...
#
# Output:
#   alle_schilders/out_vgg16_feature_extraction_aug/
#     best_model.keras
...
OUT_DIR = BASE_DIR / "out_vgg16_feature_extraction_aug"
...
def evaluate_and_save(model, test_ds, class_names, out_dir: Path):
    ...
    ax.set_title("Confusion Matrix — VGG16 FE + Augmentation (Testset)")
    fig.tight_layout()
...
# Plaats augmentatie VOOR preprocess_input.
data_augmentation = keras.Sequential(
    [
        layers.RandomFlip("horizontal"),
        layers.RandomRotation(0.05),
        layers.RandomZoom(0.10),
        # optioneel: layers.RandomContrast(0.10),
    ],
...
# Model: VGG16 conv base frozen (feature extraction) + augmentation
...
base_model.trainable = False  # <-- frozen conv base
